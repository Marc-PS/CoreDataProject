...
class DetailViewController: UIViewController {
    ...
    lazy var noteTitle: UITextField = {
        ...
        noteTitle.placeholder = "Type note title"
        return noteTitle
    }()
    ...
    lazy var noteContent: UITextField = {
        ...
        noteContent.placeholder = "Write here your note content..."
        return noteContent
    }()
    ...
    lazy var collectionImagesView: UICollectionView = {
        ...
        collectionImagesView.register(UICollectionViewCell.self, forCellWithReuseIdentifier: "DetailImage")
...
extension DetailViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "DetailImage", for: indexPath)
        guard let photo = fetchResultController?.object(at: indexPath) as? PhotoMO,
            ...
            if let urlImage = info[.imageURL] as? URL,
               ...
               let imageThumbnailData = imageThumbnail.pngData() {
                ...
                dataController.performInBackground { [weak self] (privateMOC) in
                    ...
                    let photo = PhotoMO.createPhoto(image: imageThumbnailData, managedObjectContext: privateMOC)

...
protocol NewViewControllerDelegate: AnyObject {
    func newNoteCreated()
}

class NewViewController: UIViewController {
    
    weak var viewDelegate: NewViewControllerDelegate?
        ...
        picker.dismiss(animated: true) { [unowned self] in
            if let urlImage = info[.imageURL] as? URL,
               ...
               let imageThumbnailData = imageThumbnail.pngData() {
                ...
                let photo = PhotoMO.createPhoto(image: imageThumbnailData, managedObjectContext: self.dataController.viewContext)
